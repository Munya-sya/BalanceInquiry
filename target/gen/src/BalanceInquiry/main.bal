...
public function main() {
    ...
    get_Mock_space_KCB_space_Balance_space_inquiry__1_0_0_service();
...
public function get_Mock_space_KCB_space_Balance_space_inquiry__1_0_0_service() {
    string[] Mock_space_KCB_space_Balance_space_inquiry__1_0_0_service = [ "post45338f7bde9c4712b38bbe0e40718615"
                                ];
    totalResourceLength = totalResourceLength +  Mock_space_KCB_space_Balance_space_inquiry__1_0_0_service.length();
    gateway:populateAnnotationMaps("Mock_space_KCB_space_Balance_space_inquiry__1_0_0", Mock_space_KCB_space_Balance_space_inquiry__1_0_0, Mock_space_KCB_space_Balance_space_inquiry__1_0_0_service);
...
public function initInterceptorIndexes() {
    ...
    initInterceptorIndexesMock_space_KCB_space_Balance_space_inquiry__1_0_0();
